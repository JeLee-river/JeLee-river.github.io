...
- 콘솔창을 확인한 결과, `selectedCategory`에 사용자가 선택한 카테고리의 id가 담기지 않는다는 사실을 알게 되었다.
 ...
 <br>  
   ...
   ![useEffect Console Image]({{site.img_url}}/argumentDebuging.png)
...
![Category Console Image]({{site.img_url}}/debugingCategories.gif)
...
![React Dev Document Image]({{site.img_url}}/ReactDevCustomHook.png)
...
![React Dev Document Image]({{site.img_url}}/FixDestinationsRendering.gif)
